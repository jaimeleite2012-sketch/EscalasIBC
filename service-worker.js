const CACHE_NAME='escalas-ibc-v6-0-sprint1';
const FILES=['./','./index.html','./manifest.json','./og-image-v60.jpg','./assets/icon-180.png','./assets/icon-192.png','./assets/icon-512.png'];
